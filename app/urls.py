...
urlpatterns = [
    ...
    path('wishlist/', views.wishlist, name='wishitem'),
    ...
    path('passwordchangedone/', auth_view.PasswordChangeDoneView.as_view(template_name='app/passswordchangedone.html'), name='passwordchangedone'),
...
admin.site.site_header = "Dabba Service"